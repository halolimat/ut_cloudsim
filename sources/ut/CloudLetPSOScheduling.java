...
public class CloudLetPSOScheduling {
	 ...
	 */	
	public int[] getScheduledCloudLets(List<Cloudlet> cloudletList, List<Vm> vmlist) {
		
		int[] res = null;
		
		res = run(cloudletList, vmlist);			
				
		return res;
	}
	
	private int[] run(List<Cloudlet> cloudletList, List<Vm> vmlist) {
